...
import androidx.compose.ui.unit.dp // ต้อง Import ตัวนี้เพิ่ม
...
// Data class และ List ข้อมูลไว้ด้านล่างสุดเหมือนเดิม
data class Pokemon(val name: String, val number: Int)
