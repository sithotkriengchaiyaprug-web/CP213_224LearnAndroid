...
import com.example.a224_lablearnandroid.LifeCycleComposeActivity
...
class RPGCardActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            // ส่ง Action การคลิกรูปภาพเข้าไปแทน เพื่อไม่ให้ผูกติดกับ Activity โดยตรง
            RPGCardView(
                onProfileClick = {
    ...
    Column(
        ...
        Image(
            ...
            modifier = Modifier
                ...
                .padding(top = 16.dp)
                .clickable { onProfileClick() } // ใช้ Lambda ที่ส่งเข้ามาแทน
        )
        ...
        Row(
            ...
            // ใช้ Composable ที่แยกไว้มาช่วยวาด เพื่อลดโค้ดซ้ำ
...
// แยกส่วน UI ของปุ่มเพิ่มลด Stat ออกมาเป็น Reusable Composable
@Composable
fun StatControl(
    name: String,
    value: Int,
    ...
    Column(
        ...
        horizontalAlignment = Alignment.CenterHorizontally // จัดกึ่งกลางให้สวยงาม
    ) {
        ...
        Button(onClick = onDecrease) {
            Image(
                ...
                contentDescription = "down", // แก้ไข Description
                modifier = Modifier.size(30.dp)
            )
        }
    }
