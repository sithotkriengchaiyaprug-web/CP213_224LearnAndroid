...
class AppPreferences @Inject constructor(
    ...
    var autoScannedCount: Int
        get() = prefs.getInt(KEY_AUTO_SCANNED_COUNT, 0)
        set(value) = prefs.edit().putInt(KEY_AUTO_SCANNED_COUNT, value).apply()
    ...
    companion object {
        ...
        private const val KEY_AUTO_SCANNED_COUNT = "auto_scanned_count"
    }
}
